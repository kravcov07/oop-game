...
void test_game_field_functionality() {
    ...
    try {
        ...
        std::cout << "Valid position (5,5): " << field.is_coordinates_valid(5, 5) << std::endl;
        std::cout << "Invalid position (-1,5): " << field.is_coordinates_valid(-1, 5) << std::endl;
        std::cout << "Invalid position (20,20): " << field.is_coordinates_valid(20, 20) << std::endl;
